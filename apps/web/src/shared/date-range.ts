...
] satisfies Array<{ value: DateRangePreset; label: string }>;
...
export function inferPreset(from: string, to: string, today: string): DateRangePreset {
  for (const option of dateRangePresetOptions) {
